...
function initMap() {
  // styles definition included in own file,
  // [styles].js is preloaded in html bc js code for styles is huge
  ...
  map = new google.maps.Map(document.getElementById('map'), {
    ...
    zoom: 13,
    styles: styles,
    mapTypeControl: false// - not sure if needed
  });
  ...
  drawingManager.addListener('polygoncomplete', function(polygon) {
    alertPolyArea(polygon);
    polygon.getPath().addListener('set_at', alertPolyArea);
    polygon.getPath().addListener('insert_at', alertPolyArea);
  });
}
